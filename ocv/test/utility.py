...
# function to build the Huffman tree.py and store it
# in minHeap
...
if __name__ == "__main__":
	minHeap = []
	str = 'fffffffffffffffffffffffffffffffffffffffffffffccccccccccccdddddddddddddaaaaabbbbbbbbbeeeeeeeeeeeeeeee'
	...
	print(encodedString[:len(encodedString)//2 - 1])
	print(encodedString[len(encodedString) // 2 - 1:])
